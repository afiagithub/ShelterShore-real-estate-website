    ...
    return (
        <footer className="px-10 lg:px-14 py-5 divide-y bg-[#70296333]">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 mx-auto sm:grid-cols-4 md:grid-cols-3">
                    ...
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase text-deep-purple font-bold text-xl">Company</h3>
                        <ul className="space-y-1">
                            <li>
                    ...
                    <div className="space-y-3">
                        <div className="uppercase text-deep-purple font-bold text-xl">Social media</div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">
                © 2024 ShelterShore Co. All rights reserved.</div>
        </footer>
    );
};
